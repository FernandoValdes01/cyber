...
Utiliza esta lista de verificación para evaluar tu propio progreso. Marca cada ítem que hayas completado.
...
| Se implementó Podman rootless (opcional pero valorado) | ☐ | ☐ |
...
| Se incluyen capturas de pantalla del funcionamiento | ☐ | ☐ |
| El repositorio tiene README con instrucciones claras | ☐ | ☐ |

## ¡Autoevaluación!

Si marcaste "✅ Lo logré" en todos los criterios de las secciones A, B, C, D y E, ¡has completado exitosamente la actividad! Si tienes "🔄 En progreso" en alguno, revisa nuevamente los pasos y consulta con tu equipo o con el profesor.
